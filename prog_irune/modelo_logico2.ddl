...
ALTER TABLE Trabajadores ADD CONSTRAINT Trabajadores_Centro_FK FOREIGN KEY (Centros_id_centro)
...
INSERT INTO Trabajadores VALUES ('11111111A','Aritz','Garcia','Martinez','calle Perdida','1','1','Dcha','645783521','694525315','21/03/1990',999.99,'A','111111111');
INSERT INTO Trabajadores VALUES ('22222222B','Amaia','Gomez','Pereda','calle Nula','4','2','Izqu','612785432','698452135','12/11/1895',999.99,'L','111111111');
INSERT INTO Trabajadores VALUES ('33333333C','Jon','Fernandez','Larrinoa','calle Salida','7','3','Dcha','678541235','698523214','02/09/1893',999.99,'A','222222222');
INSERT INTO Trabajadores VALUES ('44444444D','Ane','Anton','Salazar','calle Arriaga','11','4','Izqu','687521432','698532147','06/05/1892',999.99,'L','222222222');
INSERT INTO Trabajadores VALUES ('55555555E','Markel','Madina','Roldan','calle Alacala','15','5','Dcha','678521456','698632564','15/08/1890',999.99,'A','333333333');
INSERT INTO Trabajadores VALUES ('66666666F','Naia','Azkorreta','Gutierrez','calle Paz','1','6','Izqu','689452512','632124574','08/06/1998',999.99,'L','333333333');
INSERT INTO Trabajadores VALUES ('77777777G','Nicolas','Masvidal','Cuesta','calle Erre','1','7','Dcha','645127898','632541278','16/09/1991',999.99,'A','444444444');
INSERT INTO Trabajadores VALUES ('88888888H','Leire','Munar','Bengoa','calle Zapa','1','8','Izqu','698572514','678523659','30/10/1995',999.99,'L','444444444');
INSERT INTO Trabajadores VALUES ('99999999I','Aimar','Corres','Bueno','calle Kutxi','1','9','Dcha','698542132','698632589','11/05/1993',999.99,'A','555555555');
INSERT INTO Trabajadores VALUES ('00000000J','Hodei','Quintas','Prieto','calle Pinto','1','10','Izqu','698523258','689452132','26/08/1999',999.99,'L','555555555');


CREATE OR REPLACE PACKAGE PAQPROYECTO IS
  ...
  PROCEDURE VER_TRABAJADORES(P_ID_CENTRO IN Centros.id_centro%TYPE, T_CURSOR OUT g_cursor);

END PACKFASE3;


CREATE OR REPLACE PACKAGE BODY PAQPROYECTO IS
...
PROCEDURE VER_TRABAJADORES(P_ID_CENTRO IN Centros.id_centro%TYPE, T_CURSOR OUT g_cursor) IS
BEGIN
...
delete from trabajadores where DNI = '72852013L';
